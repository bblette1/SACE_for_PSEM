...
# No Early Effect assumption set for HVTN505 application
...
analyze_data_B <- function(data, S_star_choice, beta, contrast="logRR") {
  ...
  # estimate probability control has S_star observed (i.e., the probability R is 1 in controls)
  ...
  # Estimate identifiable parameters risk_z and p_00, p_10, p_11 (involving S_star)
  ...
  # where risk_z(s1,s0) = Pr[Y(z)=1 | S*(1)=s1, S*(0)=s0, Y_tau(1)=Y_tau(0)=0 ]
...
#  II1 <- (1- risk_1_10/risk_0_10_first) - (1- risk_1_00/risk_0_00_first)
#  II2 <- (1- risk_1_10/risk_0_10_second) - (1- risk_1_00/risk_0_00_second)

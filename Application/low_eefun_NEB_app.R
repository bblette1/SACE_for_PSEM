ScenarioC_low_eefun_minmin <- function(data, beta0range, beta1range, contrast) {
...
ScenarioC_low_eefun_minmax <- function(data, beta0range, beta1range, contrast) {
...
ScenarioC_low_eefun_maxmin <- function(data, beta0range, beta1range, contrast) {
...
ScenarioC_low_eefun_maxmax <- function(data, beta0range, beta1range, contrast) {
...
ScenarioC_low_eefun_cc_minmin <- function(data, beta0range, beta1range, contrast) {
...
ScenarioC_low_eefun_cc_minmax <- function(data, beta0range, beta1range, contrast) {
...
ScenarioC_low_eefun_cc_maxmin <- function(data, beta0range, beta1range, contrast) {
...
ScenarioC_low_eefun_cc_maxmax <- function(data, beta0range, beta1range, contrast) {
